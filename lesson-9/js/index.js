...
let scottsCoffee = new Coffee("medium", false, 2, 1);
output.textContent = scottsCoffee.description();
...
output.textContent = robertCoffee.description(); // This will output the same description as scottsCoffee, since robertCoffee is based on scottsCoffee.
